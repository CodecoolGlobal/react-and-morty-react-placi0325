...
const LocationList = (props) => {
    ...
    // if (props.locationCondition === "allCharacter") {
        return (<>
            ...
            {singleCharacter && data && data.results.map((location)=>(<LocationListItem location={location} setContent={props.setContent} setLocationCondition={props.setLocationCondition} name={""} dimension={""}/>))}
        </div>
        </>)
    // } else {
